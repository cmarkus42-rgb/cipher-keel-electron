...
und Schlüssel des lokalen HTTP-Servers direkt nach dem Start). Eine Sitzung, die einen Neustart
der App überlebt hat, verliert sie und bekommt sie nicht zurück, bis sie zerstört und neu
angelegt wird (siehe `docs/anpassbare-flaechen.md`, Abschnitt „Was fehlt", für den vollen
Befund):
